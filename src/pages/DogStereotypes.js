...
export function DogStereotypes() {
  return (
    <>
      <>
        <div className="cat-facts-container">
          ...
          <Link className="" to="/dog-facts"><button className="btn btn-outline-primary">Home</button></Link>
           <Link className="" to="/dog-facts/plays"><button className="btn btn-outline-primary">Previous</button></Link>
           <Link className="" to="/dog-facts/about-dog"><button className="btn btn-outline-primary">Next</button></Link>
