...
export function AboutDog() {
  const [dogFunFact, setDogFunFact] = useState("");
  useEffect(() => {
    Axios.get("https://dog-api.kinduff.com/api/facts").then((res) => {
      setDogFunFact(res.data.fact);
    });
  }, []);
  return (
    <>
      <>
        <div className="cat-facts-container">
          ...
          <Link className="" to="/dog-facts"><button className="btn btn-outline-primary">Home</button></Link>
           <Link className="" to="/dog-facts/stereotypes"><button className="btn btn-outline-primary">Previous</button></Link>
           <Link className="" to="/dog-facts/occurs"><button className="btn btn-outline-primary">Next</button></Link>
           <Link className="" to="/dog-facts/stereotypes"><button className="btn btn-outline-primary">Last</button></Link>
          
          </motion.div>
        <div className="funFact">
        <p className="api-info-cat">Random info about dog: {dogFunFact}</p>
